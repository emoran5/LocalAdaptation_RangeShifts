...
load("PerenMod_LA_20_Shift.RData")
...
write.table(Pop.i,"PostShiftPop_Peren_LA_20.txt")  
#write.table(Pop.i,"PostShiftPop_Peren_LA_80.txt")    
   ...
   jpeg(filename="PostShiftPop_Peren_LA_alleles_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="PostShiftPop_Peren_LA_alleles_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="PerenMod_LA_20_PostShift.RData")   
#save.image(file="PerenMod_LA_80_PostShift.RData") 
