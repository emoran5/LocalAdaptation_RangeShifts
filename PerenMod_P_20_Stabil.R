...
#export as text file
Pop.i <- N
write.table(Pop.i,"StablePop_Peren_P_20.txt")  
#write.table(Pop.i,"StablePop_Tree_P_80.txt")    
   ...
   mat.pop.state <- matrix(pop.state,ncol=Plot.width,nrow=Plot.length,byrow=T)
      jpeg(filename="StablePop_Peren_P_20.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="PerenMod_P_20_Stabil.RData")   
#save.image(file="PerenMod_P_80_Stabil.RData") 
