...
write.table(Pop.i,"InitialPop_Peren_LA.txt") 
...
jpeg(filename="DispersalKernels_peren",width=6,height=6, units='in', res=500)
plot(x1,pd.20,xlim=c(0,300),type='l',lwd=2,ylab="probability density",xlab="distance (m)")
points(x1,pd.80,type='l',lwd=2,lty=2)
points(x1,pd.p,type='l',lwd=2,col='blue')
legend(200,4e-04,legend=c("20 m seed","80 m seed","pollen"),lwd=c(2,2,2),lty=c(1,2,1),col=c('black',"black","blue"),cex=0.8)
dev.off()
...
jpeg(filename="SeedDisp_peren_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="SeedDisp_peren_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="PerenMod_LA_Setup.RData")