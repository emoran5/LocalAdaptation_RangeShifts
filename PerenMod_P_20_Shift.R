...
load("PerenMod_P_20_Stabil.RData")
...
#export as text file
Pop.i <- N
write.table(Pop.i,"ShiftPop_Peren_P_20.txt")  
#write.table(Pop.i,"ShiftPop_Peren_P_80.txt")  
...
##where are the genotypes (adults)?  
 ...
 clim.state <- matrix(kq,ncol=Plot.width,nrow=Plot.length,byrow=T)
   ...
   jpeg(filename="ShiftPop_Peren_P_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="ShiftPop_Peren_P_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="PerenMod_P_20_Shift.RData")   
#save.image(file="PerenMod_P_80_Shift.RData") 	 
