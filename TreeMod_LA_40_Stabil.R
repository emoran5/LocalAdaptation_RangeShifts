...
write.table(Pop.i,"StablePop_Tree_LA_40.txt")  
#write.table(Pop.i,"StablePop_Tree_LA_80.txt")    
   ...
   jpeg(filename="StablePop_Tree_LA_alleles_40.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="TreeMod_LA_40_Stabil.RData")   
#save.image(file="TreeMod_LA_80_Stabil.RData") 
