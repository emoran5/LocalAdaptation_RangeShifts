#20 years of population stabilization after climate shift
#Output:Map of stable allele distribution, text file of population numbers, saved workspace

load("AnnMod_LA_20_Shift.RData")

#allow 20 yrs to re-stabilize
   TT3 <- 1:20  
...
#write.table(Pop.i,"PostShiftPop_Annual_LA_1.txt")  
write.table(Pop.i,"PostShiftPop_Annual_LA_20.txt")   
#write.table(Pop.i,"PostShiftPop_Annual_LA_50.txt") 
...
#jpeg(filename="PostShiftPop_Annual_LA_alleles_1.jpg",width=9,height=7, units='in', res=500)
jpeg(filename="PostShiftPop_Annual_LA_alleles_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="PostShiftPop_Annual_LA_alleles_50.jpg",width=9,height=7, units='in', res=500)
...
#save.image(file="AnnMod_LA_1_PostShift.RData")   
save.image(file="AnnMod_LA_20_PostShift.RData") 
#save.image(file="AnnMod_LA_50_PostShift.RData")     
