...
#export as text file
Pop.i <- N
write.table(Pop.i,"PostShiftPop_Tree_P_40.txt")  
#write.table(Pop.i,"PostShiftPop_Tree_P_80.txt")    
 ...
 clim.state <- matrix(kq,ncol=Plot.width,nrow=Plot.length,byrow=T)
   ...
   jpeg(filename="PostShiftPop_Tree_P_alleles_40.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="PostShiftPop_Tree_P_alleles_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="TreeMod_P_40_PostShift.RData")   
#save.image(file="TreeMod_P_80_PostShift.RData") 
