#200 years of population stabilization after climate shift
#Output:Map of stable allele distribution, text file of population numbers, saved workspace

load("TreeMod_LA_40_Shift.RData")

#allow 200 yrs to re-stabilize
   TT3 <- 1:200  
...
write.table(Pop.i,"PostShiftPop_Tree_LA_40.txt")  
#write.table(Pop.i,"PostShiftPop_Tree_LA_80.txt")    
   ...
   jpeg(filename="PostShiftPop_Tree_LA_alleles_40.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="PostShiftPop_Tree_LA_alleles_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="TreeMod_LA_40_PostShift.RData")   
#save.image(file="TreeMod_LA_80_PostShift.RData") 
