...
load("PerenMod_LA_20_Stabil.RData")
...
write.table(Pop.i,"ShiftPop_Peren_LA_20.txt")  
#write.table(Pop.i,"ShiftPop_Peren_LA_80.txt")  
...
##where are the genotypes (adults)?  
 ...
 clim.state <- matrix(kq,ncol=Plot.width,nrow=Plot.length,byrow=T)
   ...
   jpeg(filename="ShiftPop_Peren_LA_alleles_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="ShiftPop_Peren_LA_alleles_80.jpg",width=9,height=7, units='in', res=500)
...
save.image(file="PerenMod_LA_20_Shift.RData")   
#save.image(file="PerenMod_LA_80_Shift.RData") 	 
