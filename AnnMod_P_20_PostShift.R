...
#write.table(Pop.i,"PostShiftPop_Annual_P_1.txt")  
write.table(Pop.i,"PostShiftPop_Annual_P_20.txt")   
#write.table(Pop.i,"PostShiftPop_Annual_P_50.txt") 
...
#jpeg(filename="PostShiftPop_Annual_P_alleles_1.jpg",width=9,height=7, units='in', res=500)
jpeg(filename="PostShiftPop_Annual_P_alleles_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="PostShiftPop_Annual_P_alleles_50.jpg",width=9,height=7, units='in', res=500)
...
#save.image(file="AnnMod_P_1_PostShift.RData")   
save.image(file="AnnMod_P_20_PostShift.RData") 
#save.image(file="AnnMod_P_50_PostShift.RData")     
