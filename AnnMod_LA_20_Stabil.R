...
#write.table(Pop.i,"StablePop_Annual_LA_1.txt")  
write.table(Pop.i,"StablePop_Annual_LA_20.txt")   
#write.table(Pop.i,"StablePop_Annual_LA_50.txt") 
...
#jpeg(filename="StablePop_Annual_LA_alleles_1.jpg",width=9,height=7, units='in', res=500)
jpeg(filename="StablePop_Annual_LA_alleles_20.jpg",width=9,height=7, units='in', res=500)
#jpeg(filename="StablePop_Annual_LA_alleles_50.jpg",width=9,height=7, units='in', res=500)
...
#save.image(file="AnnMod_LA_1_Stabil.RData")   
save.image(file="AnnMod_LA_20_Stabil.RData") 
#save.image(file="AnnMod_LA_50_Stabil.RData")  